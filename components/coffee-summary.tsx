    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 sm:px-8 sm:py-12 sm:gap-x-8 md:py-16">
      ...
      <div className="col-start-1 row-start-3 space-y-3 px-4">
        <p className="flex items-center text-black text-sm font-medium">
          <img
            alt="coffee"
            data-src="https://res.cloudinary.com/dowk3qjxu/image/upload/v1607197009/IMG_2004_sjd6sz.jpg"
            className="cld-responsive w-6 h-6 rounded-full mr-2 bg-gray-100"
          ></img>
      ...
      <div className="col-start-1 row-start-1 flex sm:col-start-2 sm:row-span-3">
        <div className="w-full grid grid-cols-3 grid-rows-2 gap-2">
          <div className="relative col-span-3 row-span-2 md:col-span-2">
            <img
              src="https://res.cloudinary.com/dowk3qjxu/image/upload/v1607197009/IMG_2004_sjd6sz.jpg"
              alt=""
