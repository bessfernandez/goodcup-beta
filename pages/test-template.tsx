...
const TestTemplate = ({ token }) => {
  ...
  <div className="relative bg-indigo-600 pb-32 overflow-hidden">
          ...
          <div className="flex-1 px-2 flex justify-center lg:ml-6 lg:justify-end">
            <div className="max-w-lg w-full lg:max-w-xs">
              ...
              <div className="relative text-indigo-400 focus-within:text-indigo-400">
                ...
                <input id="search" name="search" className="block w-full bg-indigo-700 bg-opacity-50 py-2 pl-10 pr-3 border border-transparent rounded-md leading-5 placeholder-indigo-200 focus:outline-none focus:bg-indigo-500 focus:ring-white focus:border-indigo-400 focus:placeholder-indigo-300 focus:text-coolGrey-100 sm:text-sm" placeholder="Search" type="search" />
              </div>
            </div>
          </div>
          <div className="flex lg:hidden">
            <button className="p-2 rounded-md inline-flex items-center justify-center text-indigo-300 hover:text-white hover:bg-light-blue-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-expanded="false">
          ...
          <div className="hidden lg:block lg:ml-4">
            <div className="flex items-center">
              ...
              <div className="relative flex-shrink-0 ml-4">
                <div>
                  <button className="rounded-full flex text-sm text-white focus:outline-none focus:bg-light-blue-900 focus:ring-2 focus:ring-offset-2 focus:ring-offset-light-blue-900 focus:ring-white" id="user-menu" aria-haspopup="true">
                    <span className="sr-only">Open user menu</span>
                    <img className="rounded-full h-8 w-8" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=htmlFormat&fit=facearea&facepad=4&w=256&h=256&q=80" alt="" />
                  </button>
                </div>
      ...
      <div className="bg-light-blue-900 hidden lg:hidden">
        ...
        <div className="pt-4 pb-3 border-t border-indigo-300 ">
          <div className="flex items-center px-4">
            <div className="flex-shrink-0">
              <img className="rounded-full h-10 w-10" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=htmlFormat&fit=facearea&facepad=4&w=256&h=256&q=80h" alt="" />
            </div>
            <div className="ml-3">
    ...
    <div className="absolute flex justify-center inset-x-0 left-1/2 transhtmlForm -translate-x-1/2 w-full overflow-hidden lg:inset-y-0" aria-hidden="true">
      ...
      <svg className="flex-shrink-0" width="1750" height="308" viewBox="0 0 1750 308" xmlns="http://www.w3.org/2000/svg">
        <path opacity=".75" d="M1465.84 308L16.816 0H1750v308h-284.16z" fill="#647ACB" />
        <path opacity=".75" d="M1733.19 0L284.161 308H0V0h1733.19z" fill="#4055A8" />
      </svg>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
          <aside className="py-6 lg:col-span-3">
            <nav>
              <a href="#" className="group bg-teal-50 border-l-4 border-indigo-300 px-3 py-2 flex items-center text-sm font-medium text-teal-700 hover:bg-teal-50 hover:text-teal-700" aria-current="page">
                <svg className="flex-shrink-0 -ml-1 mr-3 h-6 w-6 text-teal-500 group-hover:text-teal-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              ...
              <a href="#" className="group mt-1 border-l-4 border-transparent px-3 py-2 flex items-center text-sm font-medium text-gray-900 hover:bg-gray-50 hover:text-gray-900">
            ...
            <div className="py-6 px-4 sm:p-6 lg:pb-8">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  This inhtmlFormation will be displayed publicly so be careful what you share.
                </p>
              </div>
              ...
              <div className="mt-6 flex flex-col lg:flex-row">
                <div className="flex-grow space-y-6">
                  <div>
                    ...
                    <div className="mt-1 rounded-md shadow-sm flex">
                      ...
                      <input type="text" name="username" id="username" autoComplete="username" className="focus:ring-light-blue-500 focus:border-light-blue-500 flex-grow block w-full min-w-0 rounded-none rounded-r-md sm:text-sm border-indigo-300 " value="lisamarie" />
                    </div>
                  </div>
                ...
                <div className="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-grow-0 lg:flex-shrink-0">
                  ...
                  <div className="mt-1 lg:hidden">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 inline-block rounded-full overflow-hidden h-12 w-12" aria-hidden="true">
                        <img className="rounded-full h-full w-full" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=htmlFormat&fit=facearea&facepad=4&w=256&h=256&q=80h" alt="" />
                      </div>
                      <div className="ml-5 rounded-md shadow-sm">
                        <div className="group relative border border-indigo-300 rounded-md py-2 px-3 flex items-center justify-center hover:bg-gray-50 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-light-blue-500">
                          ...
                          <input id="user_photo" name="user_photo" type="file" className="absolute w-full h-full opacity-0 cursor-pointerborder-indigo-300 rounded-md" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="hidden relative rounded-full overflow-hidden lg:block">
                    <img className="relative rounded-full w-40 h-40" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=htmlFormat&fit=facearea&facepad=4&w=320&h=320&q=80" alt="" />
                ...
                <ul className="mt-2 divide-y divide-gray-200">
                  <li className="py-4 flex items-center justify-between">
                    ...
                    <button type="button" aria-pressed="true" aria-labelledby="privacy-option-label-1" aria-describedby="privacy-option-description-1" className="ml-4 bg-gray-200 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-blue-500">
                      ...
                      <span aria-hidden="true" className="translate-x-0 inline-block h-5 w-5 rounded-full bg-white shadow transhtmlForm ring-0 transition ease-in-out duration-200"></span>
                    </button>
                  </li>
                  <li className="py-4 flex items-center justify-between">
                    <div className="flex flex-col">
